...
Jede Kategorie hat ein alter ego: den sogenannten Startartikel. Dieser wird automatisch von Redaxo erzeugt wenn eine neue Kategorie angelegt wird, sprich: _leere Kategorien gibt es in Redaxo nicht.. in diesem Punkt weicht die Analogie zur PC Festplatte ab_.
...
*Sicherheitshinweis:* _Auch wenn die Begriffe online/offline dies vermuten lassen, bewirkt ein offline Status _nicht_ das der Artikel nicht aufrufbar wäre. Der Status online/offline hat lediglich steuernde Funktion, keine schützende. Über den einfachen Linkaufbau @http://DOMAIN.TLD/index.php?article_id=n@ und willkürliche Eingabe einer Zahl für n ist jede Seite einer Standard Redaxoinstallation aufrufbar._
